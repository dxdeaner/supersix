      ...
      <form method="POST" action="<?php echo base_url();?>user_manage/create_user<?php echo '/'.$this->uri->segment(3);?>" name="add_user" enctype="multipart/form-data" onsubmit="return validate()">
           <div class="col-lg-6">
            ...
            <div class="col-lg-6">
              ...
              <option value="male" <?php if(isset($userinfo->gender)){ if($userinfo->gender=='male') {echo 'selected';} }?>>Male</option>
              <option value="female" <?php if(isset($userinfo->gender)){ if($userinfo->gender=='female') {echo 'selected';}} ?>>Female</option>
            ...
            <div class="col-lg-2 DobLbl">
              <span class="content">Profile Image</span>
            </div>
