      ...
      <div class="col-lg-12">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="clearfix">
              <h1 class="pull-left">Creat New Event</h1>
            </div>
            ...
            <div class="main-box-body clearfix">          
                ...
                <form class="form-horizontal" method="post">
                  ...
                  <div class="form-group">
                    <label class="col-md-3 control-label" for="event_name">Event</label>  
                    <div class="col-md-6">
             ...
             <!-- Textarea -->
                  <div class="form-group">
                    <label class="col-md-3 control-label" for="textarea">Event Description</label>
                    <div class="col-md-6">                     
                ...
                <div class="form-group">
                  <label class="col-md-3 control-label">Select Employe</label>  
                  <div class="col-sm-6">
