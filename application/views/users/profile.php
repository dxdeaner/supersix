...
<div class="row" style="opacity: 1;">
  <div class="col-lg-12">
    ...
    <?php if($this->session->flashdata('message') || @$message!="") {
       $msg = $this->session->flashdata('message') ? $this->session->flashdata('message') : $message; ?>
      <div class="alert alert-success col-lg-10 col-sm-offset-1">
        <a href="#" class="close" data-dismiss="alert">&times;</a>
        <?php echo @$msg; ?>
      </div>
        <?php }else if($this->session->flashdata('error')|| @$error!=""){ $msg = $this->session->flashdata('error') ? $this->session->flashdata('error') : $error; ?>
            ...
            <div class="main-box clearfix"> 
              <div class="main-box-body clearfix">
                ...
                <div class="profile-label">
                  ...
                  <?php echo ucfirst($user->first_name).' '.ucfirst($user->last_name);?></span>
                </div>
            ...
            <div class="main-box clearfix">
              <div class="tabs-wrapper profile-tabs">
                <ul class="nav nav-tabs">
                  ...
                  <li class="">
                    <a href="#Change_pass" data-toggle="tab" aria-expanded="false">Change Password</a>
                  </li>
                  <li class="">
                    <a href="#more_info" data-toggle="tab" aria-expanded="false">More Info</a>
                  </li>
                </ul>
...
<div class="tab-pane fade active in" id="basic_info">
  ...
  <div id="admin_adit">  
    <form method="post" action="<?php echo base_url();?>users/profile/edit_user_profile">
    <table class="table">
      <tbody>      
      <tr>
        <td>User Name</td>        
...
<div id="newsfeed">
          ...
          <div class="main-box no-header clearfix">
            <div class="main-box-body clearfix">          
                ...
                <form class="form-horizontal" action="<?php echo base_url();?>users/profile/index" method="post">
                  <fieldset>
                  <!-- Text input-->
                  <a>
  ...
  <div id="newsfeed">        
    <table class="table">
      <tbody>
        ...
        <tr> 
          <td>Skill</td>
           <td><?php echo ucfirst($user->skill); ?></td>            
        </tr>
        <tr><td>Exprerince</td>
        ...
        <tr>
          <td>Joining Date</td>
            <td><?php echo date ("d/m/Y",strtotime($user->joiningdate)); ?></td>
        </tr>
          <tr>
            <td>Last Login</td>                
              <td><?php echo date ("d/m/Y h:ia",strtotime($user->last_login)); ?></td>
          </tr>
          <tr>
            <td>Phone</td> 
          ...
          <tr>
           ...
           <td><?php echo ucfirst($user->paddress); ?></td>
          </tr>
          <tr>
            <td>State</td>
